                            ...
                            <form class="">
                                <div class="flex flex-wrap -mx-3 mb-6">
                                    ...
                                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                        ...
                                        <div class="mt-2">
                                            <select wire:model="category_kunyit_id" id="category_kunyit_id" name="category_kunyit_id" autocomplete="category_kunyit_id" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white">
                                                <option>Select One</option>
                                                @foreach ($categories as $category)
                                                <option value="{{ $category->id }}">{{ $category->description }}</option>
                                                @endforeach
                                            </select>
                                            @error('category_kunyit_id')
                                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                            @enderror
