                            ...
                            <form class="">
                                <div class="flex flex-wrap -mx-3 mb-6">
                                    ...
                                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                        ...
                                        <div class="mt-2">
                                            <select wire:model="category_beverages_id" id="category_beverages_id" name="category_beverages_id" autocomplete="category_beverages_id" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white">
                                                <option>Select One</option>
                                                @foreach ($categories as $category)
                                                <option value="{{ $category->id }}">{{ $category->description }}</option>
                                                @endforeach
                                            </select>
                                            @error('category_beverages_id')
                                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                            @enderror
                                ...
                                <div class="flex flex-wrap -mx-3">
                                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                        ...
                                        <input wire:model="price_glass" type="number" name="price_glass" id="price_glass"  class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white">
                                        @error('price_glass')
                                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                        ...
                                        <input wire:model="price_bottle" type="number" name="price_bottle" id="price_bottle"  class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white">
                                        @error('price_bottle')
                                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-2">
                                    ...
                                    <input wire:model='image' class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none" id="file_input" type="file" enctype="multipart/form-data">
                                    @error('image')
                                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div wire:ignore class="mb-6">
                                    ...
                                    <x-input.select wire:model="tag_ids" prettyname="beverage_tag" :options="$tags" optionKey="id" :selected="$selected_tags" optionLabel="title"/>
                                </div>
